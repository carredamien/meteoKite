<template>
  <section class="time">
      ...
      <div class="slideshow-container" @mousedown = "mousedown($event)" @mousemove = "mousemove($event)" @mouseup = "mouseup" @mouseleave = "mouseleave" @touchstart = "touchstart($event)" @touchmove = "touchmove($event)" @touchend = "touchend">
      <div class="slideshow">
        <div class="slide s1"  >
  ...
  export default {
    ...
    methods: {
      mousedown: function(e) {
        const slider = this.$el.querySelector('.slideshow-container');
        this.holding = true;
